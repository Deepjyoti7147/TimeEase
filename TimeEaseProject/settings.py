"""
Django settings for TimeEaseProject project.
...
SECRET_KEY = 'django-insecure-#9*0#hf=e)3(4qu31f&q&#$tgv0c(eujx4k#a07y2mr1y8p7^3'
...
# We need to change this before deploying to production.
...
ROOT_URLCONF = 'TimeEaseProject.urls'
...
WSGI_APPLICATION = 'TimeEaseProject.wsgi.application'
